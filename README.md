...
This project was tested with Android Studio, Genymotion (in both, several models) and in my personal S8. I don’t have any kind of access to test it on iOS. Project is also in expo. A link will be attached with the submission.
